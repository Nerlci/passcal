...
public:
  enum {
    ...
    T__7 = 8, T__8 = 9, T__9 = 10, T__10 = 11, WS = 12, PROGRAM = 13, BEGIN = 14, 
    END = 15, VAR = 16, INTEGER = 17, IDENTIFIER = 18, NUMBER = 19
  };

  enum {
    RuleProgram = 0, RuleBlock = 1, RuleVarDeclaration = 2, RuleVariable = 3, 
    RuleStatementList = 4, RuleStatement = 5, RuleAssignment = 6, RuleExpression = 7, 
